...
<body>
    <div class="container animate__animated animate__fadeIn">
        ...
        <form method="POST" action="/" class="animate__animated animate__zoomIn">
            <div class="form-row">
            ...
            <button type="submit" class="btn btn-primary btn-block animate__animated animate__pulse animate__infinite">Apply Filter</button>
        </form>
...
<body>
    <div class="container animate__animated animate__fadeIn">
        ...
        <!-- Date range selection form -->
        <form method="POST" action="/" class="bg-light p-4 rounded shadow-sm animate__animated animate__zoomIn">
            <div class="form-row">
                <div class="col">
                    <input type="date" class="form-control" name="start_date" placeholder="Start Date">
                </div>
...
<body>
    <div class="container animate__animated animate__fadeIn">
        ...
        <!-- Date Range Display -->
        <p class="text-center">{{ date_range }}</p>
